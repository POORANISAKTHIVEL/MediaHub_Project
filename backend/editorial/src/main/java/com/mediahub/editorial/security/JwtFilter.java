package com.mediahub.editorial.security;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Editorial endpoints with public access (if any) can be added here
        ...
        try {
            ...
            // Build authorities: ROLE_<roleType> plus permissions included in the token
